...
import {
  ...
  rangeAdjustSave,
  rangeAdjustClear,
} from "@/projects/hbmu-suguan/api/sgAptRange";
      ...
      this.alert("确认进行分配吗？", "确认", {
        ...
        request() {
          return rangeAdjustSave({
            ...
            xy: me.ruleForm.xy ? me.ruleForm.xy : me.currentItem.xy,
            bjmc: me.ruleForm.bjmc ? me.ruleForm.bjmc : me.currentItem.bjmc,
          });
        },
        success() {
