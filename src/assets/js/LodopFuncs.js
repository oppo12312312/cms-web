...
export function getLodop(oOBJECT, oEMBED) {
  ...
  // var strCLodopInstall="<br><font color='#FF00FF'>CLodop云打印服务(localhost本地)未安装启动!<br>点击这里<a href='"+PROJECT.ctxPath+"/static/js/plugins/lodop/CLodop_Setup_for_Win32NT.exe' target='_self'>执行安装</a>,安装后请刷新页面。</font>";
  // var strCLodopUpdate="<br><font color='#FF00FF'>CLodop云打印服务需升级!点击这里<a href='"+PROJECT.ctxPath+"/static/js/plugins/lodop/CLodop_Setup_for_Win32NT.exe' target='_self'>执行升级</a>,升级后请刷新页面。</font>";
  var LODOP;
  try {
    var isIE =
    ...
    LODOP.SET_LICENSES(
      "北京希尔信息技术有限公司",
      "653716180837383919278901905623",
      "",
      ""
    );
    //===========================================================
